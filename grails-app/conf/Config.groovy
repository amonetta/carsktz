...
environments {
    development {
        perf4j = {
            enabled = false // default: true (only enabled in development environment)
            graphingServlet = {
                enabled = true // default: true (only enabled in development environment)
                graphNames = "performanceGraph" // defualt: "performanceGraph"
                urlPattern = "/perf4j" // default: "/perf4j"
            }
        }
    }
}
...
log4j = {
    /*appenders {
        ...
        def performanceGraphFileAppender = new org.apache.log4j.FileAppender(
                fileName: "target/log/perfGraphs.log",
        ...
        def performanceGraphAppender = new org.perf4j.log4j.GraphingStatisticsAppender(
                graphType: 'Count',      // possible options: Mean, Min, Max, StdDev, Count or TPS
                tagNamesToGraph: 'com.kaitzen.CarService.list.DBGet,com.kaitzen.CarService.list',
        ...
        def performanceStatsFileAppender = new org.apache.log4j.FileAppender(
                fileName: "target/log/perfStats.log",
